        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Editar Trámite</li>
                </ol>
            </nav>
        </div>
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-subsection">
                            <h4 class="card-title">Editar Trámite</h4>
                            <div>
                            ...
                            <div class="accordion" id="tramiteFullAccordion">
                                <div class="accordion-item mb-3">
                                    <h2 class="accordion-header" id="tramiteGeneralHeading">
                                        <button class="accordion-button {{ $isLink ? 'collapsed' : '' }}" type="button" data-bs-toggle="collapse" data-bs-target="#tramiteGeneral" aria-expanded="{{ $isLink ? 'false' : 'true' }}" aria-controls="tramiteGeneral">
                                            General
                                        </button>
                                    </h2>
                                    <div id="tramiteGeneral" class="accordion-collapse collapse {{ $isLink ? '' : 'show' }}" aria-labelledby="tramiteGeneralHeading" data-bs-parent="#tramiteFullAccordion">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="category_id" id="category_id" class="form-control">
                                                    ...
                                                    @foreach($categories as $cat)
                                                        <option value="{{ $cat->id }}" @selected(old('category_id', $tramite->category_id) == $cat->id)>{{ $cat->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                ...
                                <div class="accordion-item mb-3">
                                    <h2 class="accordion-header" id="tramiteIconHeading">
                                        <button class="accordion-button {{ $isLink ? '' : 'collapsed' }}" type="button" data-bs-toggle="collapse" data-bs-target="#tramiteIcon" aria-expanded="{{ $isLink ? 'true' : 'false' }}" aria-controls="tramiteIcon">
                                            Icono / Logo
                                        </button>
                                    </h2>
                                    <div id="tramiteIcon" class="accordion-collapse collapse {{ $isLink ? 'show' : '' }}" aria-labelledby="tramiteIconHeading" data-bs-parent="#tramiteFullAccordion">
                                        <div class="accordion-body">
                                            <div class="form-group">
                            ...
                            <div class="accordion" id="tramiteModeAccordion">
                                <div class="accordion-item mb-3">
                                    ...
                                    <div class="accordion-item mb-3">
                                        ...
                                        <div id="tramiteLink" class="accordion-collapse collapse {{ $isLink ? 'show' : '' }}" aria-labelledby="tramiteLinkHeading" data-bs-parent="#tramiteFullAccordion">
                                            <div class="accordion-body p-0">
