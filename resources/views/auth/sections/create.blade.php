                                    ...
                                    <div id="sectionGeneral" class="accordion-collapse collapse show" aria-labelledby="sectionGeneralHeading" data-bs-parent="#sectionAccordion">
                                        <div class="accordion-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title_short" id="title_short" class="form-control" value="{{ old('title_short') }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" name="order" id="order" class="form-control" value="{{ old('order', 0) }}">
                                            </div>
