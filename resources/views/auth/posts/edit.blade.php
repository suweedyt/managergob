                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-4">
                                                        <div class="form-group form-check">
                                                            ...
                                                            <input type="checkbox" class="form-check-input" id="banner_show_caption" name="banner_show_caption" value="1" @checked(old('banner_show_caption', $post->banner_show_caption ?? 1))>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="banner_button_text" id="banner_button_text" class="form-control" value="{{ old('banner_button_text', $post->banner_button_text ?? 'Leer más') }}" placeholder="Leer más">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="banner_button_bg_color">Color botón</label>
                                                            <input type="color" name="banner_button_bg_color" id="banner_button_bg_color" class="form-control-color" value="{{ old('banner_button_bg_color', $post->banner_button_bg_color ?? '#0d6efd') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
